...
public class MyThread extends Thread {
    ...
    private void getCustomerPurchasesByStore() {
        ...
        try {
            ...
            if (response instanceof java.util.HashMap) {
                @SuppressWarnings("unchecked")
                java.util.HashMap<String, java.util.AbstractMap.SimpleEntry<Integer, Double>> purchases =
                        (java.util.HashMap<String, java.util.AbstractMap.SimpleEntry<Integer, Double>>) response;
                java.util.ArrayList<Product> products = new java.util.ArrayList<>();
                for (java.util.Map.Entry<String, java.util.AbstractMap.SimpleEntry<Integer, Double>> entry : purchases.entrySet()) {
